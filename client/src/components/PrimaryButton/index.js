...
export default function PrimaryButton(props) {
  ...
  return (
    <button {...newProps} style={style} className={className}>
...
export function RoundIconButton(props) {
  ...
  return <IconButton {...props} className={className} icon={icon} />;
}
  ...
  return (
    <PrimaryButton {...props} className={className} style={style}>
      <ShouldRender if={!props.customIcon}>
        <i style={props.iconStyle} onClick={onClickIcon}>
          {props.icon}
        </i>
      </ShouldRender>

      <ShouldRender if={props.customIcon}>{props.customIcon}</ShouldRender>
